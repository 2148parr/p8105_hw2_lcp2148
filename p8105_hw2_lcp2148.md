...
The `pols_month` data set contained The dimension of the merged data
set, `merged_538`, is 1442, 12. The range of years in this merged data
set is 1950, 2015. The names of key variables are year, close, month,

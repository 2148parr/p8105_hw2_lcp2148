...
sports\_balls, homes\_powered. The median weight was 3.380 tons, and the
...
dimension, range of years, and names of key variables). The dimension of
the merged data set, `merged_538`, is 1442, 12. The range of years in
this merged data set is 1950, 2015. The names of key variables are year,
close, month, gov\_gop, sen\_gop, rep\_gop, gov\_dem, sen\_dem,
rep\_dem, president, value, unemployment
...
I then made a table using a similar process showing the most popular
name among male children over time.

For male, white non-hispanic children born in 2016, I used `ggplot` to
